---
layout: single
title: "Documentation for Bib Support for CVs"
...
#### Hidden Gem
There is an additional field `boldindex` to keep track of your own name in the articles, so that it bolds (or you can further customize it in the driver) when printing article publications.
{% raw %}
```bibtex
@article{celano2025inversions,
  author    = {Pepe Augusto and Pedro Sinnombre and Juan del Pueblo and Jim Jimenez and Jack Prime and Lucas George},
  boldindex = {3},
  title     = {Inversions in parking functions},
  journaltitle = {ArXiv},
  note      = {Submitted August 15, 2025},
  year      = {2025},
