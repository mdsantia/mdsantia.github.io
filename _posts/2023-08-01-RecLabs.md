...
### Existence
If f(t, x) is defined and continuous on a rectangle R
in the tx-plane, then given any point (t0, x0) ∈ R, the initial value problem
x
0 = f(t, x) and x(t0) = x0
has a solution x(t) defined in an interval containing t0.
