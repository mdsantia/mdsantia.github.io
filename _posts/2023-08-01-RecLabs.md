...
### Existence Theorem
If $f(t, x)$ is defined and continuous on a rectangle $R$ in the tx-plane, then given any point (t_0, x_0) ∈ R, the initial value problem x 
0 = f(t, x) and x(t_0) = x_0 
<div align="center">
    <img src=https://latex.codecogs.com/svg.image?\begin{cases}x'=f(t,x)\\x(t_0)=x_0\end{cases}, alt="dx/dt=">
</div>
has a solution $x(t)$ defined in an interval containing $t_0$.
